...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/velonic/assets/images/favicon.ico">

    <!-- Theme Config Js -->
    <script src="assets/velonic/assets/js/config.js"></script>

    <!-- App css -->
    <link href="assets/velonic/assets/css/app.min.css" rel="stylesheet" type="text/css" id="app-style" />

    <!-- Icons css -->
    <link href="assets/velonic/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
</head>
...
<body class="authentication-bg position-relative">
    ...
    <!-- Vendor js -->
    <script src="assets/velonic/assets/js/vendor.min.js"></script>
