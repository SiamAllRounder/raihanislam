  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="assets/starlite/app/widgets.html" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <div class="card widget-messages mg-t-20">
              ...
              <div class="list-group list-group-flush">
                <a href="" class="list-group-item list-group-item-action media">
                  <img src="assets/starlite/img/img10.jpg" alt="">
                  <div class="media-body">
                    <div class="msg-top">
                ...
                <a href="" class="list-group-item list-group-item-action media">
                  <img src="assets/starlite/img/img9.jpg" alt="">
                  <div class="media-body">
                    <div class="msg-top">
                ...
                <a href="" class="list-group-item list-group-item-action media">
                  <img src="assets/starlite/img/img8.jpg" alt="">
                  <div class="media-body">
                    <div class="msg-top">
                ...
                <a href="" class="list-group-item list-group-item-action media">
                  <img src="assets/starlite/img/img7.jpg" alt="">
                  <div class="media-body">
                    <div class="msg-top">
